...
Model choice: claude-sonnet-5, not the haiku model used for nudges.
A wrong nudge is mildly annoying. A wrong arbitration is either a
fraud loss or a frustrated legitimate customer -- worth spending more
reasoning on a judgment call than on a notification sentence.
